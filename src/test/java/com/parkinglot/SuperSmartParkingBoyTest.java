...
public class SuperSmartParkingBoyTest {
    ...
    //Case 4: Given a super smart parking boy, who manage two parking lots, and an unrecognized
    //ticket, When fetch the car, Then return nothing with error message Unrecognized parking ticket.
    @Test
    void should_throw_unrecognized_parking_ticket_exception_when_take_car_given_super_smart_parking_boy_two_parking_lots_and_wrong_ticket() {
        //given
        ParkingLot parkingLot1 = new ParkingLot(10);
        ParkingLot parkingLot2 = new ParkingLot(10);
        ArrayList<ParkingLot> parkingLots = new ArrayList<>();
    ...
    //Case 5: Given a super smart parking boy, who manage two parking lots, and a used ticket, When
    //fetch the car, Then return nothing with error message Unrecognized parking ticket.
    @Test
    void should_throw_unrecognized_parking_ticket_exception_when_take_car_given_super_smart_parking_boy_two_parking_lots_and_used_ticket() {
        //given
        ParkingLot parkingLot1 = new ParkingLot(10);
        ParkingLot parkingLot2 = new ParkingLot(10);
        ArrayList<ParkingLot> parkingLots = new ArrayList<>();
    ...
    //Case 6: Given a super smart parking boy, who manage two parking lots, both without any position,
    //and a car, When park the car, Then return nothing with error message No available position.
    @Test
    void should_throw_no_available_position_when_park_car_given_super_smart_parking_boy_two_parking_lots_with_no_capacity() {
        //given
